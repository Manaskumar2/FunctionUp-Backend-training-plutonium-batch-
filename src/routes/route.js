...
router.get("/films/:filmId", function(req, res){
 ...
 app.get("/sol1", function (req, res) {
    ...
    let arr= [1,2,3,5,6,7] //4 ->7(7+1)/2=7(8)/2=>7*4=28 -24=4
    let bag =0;//all total number 24
    for(let i in arr){
        bag=bag+arr[i]

    }
    let num=arr.pop()
    let sumOfNum=num*(num +1)/2;//all total =28
    let missingNumber=sumOfNum-bag //28-24=4
...
// Your route code will look like this
  app.get("/sol2", function (req, res) {
        ...
        let arr= [33, 34, 35, 37, 38]// 36 // 6*(33+38)/2=6*71*/2=213
        let n=arr.length+1
        let bag =0;//33+34+35+37+38=177
    for(let i in arr){
        bag=bag+arr[i]
    ...
    let sumOfNum=n*(firstNumber+lastNumber)/2 //all total 213
    let missingNumber=sumOfNum-bag //213-177 =36
